    ...
    <section class="container__form">
        <div class="container-cadastro">
            ...
            <div class="form-image">
                <img src="/img/login/local-na-rede-internet.png" alt="imagem cadastro">
            </div>
                ...
                <form action="/back-end/login.php" method="post">
                    ...
                    <div class="input-group-cadastro">
                        ...
                        <div class="continue-button-cadastro">
                            <button input type="submit" value="Entrar"><a href="#">Entrar</a></button>
                        </div>

                        <div class="form__cadastro">
                            <p class="form__cadastro-texto">Não possui uma conta?</p>
                            <a class="form__cadastro-link" href="/php/cadastro.php">Cadastre-se</a>
                        </div>
                    </div>
                </form>
            </div>
